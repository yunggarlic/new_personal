...
const Contact: React.FC = () => {
  return (
    <section className="flex flex-col items-center pb-48" id="contact">
      ...
      <a
        className="mt-12 rounded-lg border-2 px-8 py-4 transition duration-300  ease-in-out hover:bg-sky-200 dark:text-slate-200 dark:hover:bg-emerald-800 dark:hover:text-slate-200"
